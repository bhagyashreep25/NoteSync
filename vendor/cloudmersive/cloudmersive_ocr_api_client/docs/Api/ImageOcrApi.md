...
> \Swagger\Client\Model\FormRecognitionResult imageOcrPhotoRecognizeForm($image_file, $form_template_definition, $recognition_mode, $language)
...
try {
    $result = $apiInstance->imageOcrPhotoRecognizeForm($image_file, $form_template_definition, $recognition_mode, $language);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ReceiptRecognitionResult imageOcrPhotoRecognizeReceipt($image_file, $form_template_definition, $recognition_mode, $language)
...
try {
    $result = $apiInstance->imageOcrPhotoRecognizeReceipt($image_file, $form_template_definition, $recognition_mode, $language);
    print_r($result);
} catch (Exception $e) {
...
# **imageOcrPhotoToText**
> \Swagger\Client\Model\ImageToTextResponse imageOcrPhotoToText($image_file, $language)
...
> \Swagger\Client\Model\PhotoToWordsWithLocationResult imageOcrPhotoWordsWithLocation($image_file, $language, $preprocessing, $diagnostics)
...
try {
    $result = $apiInstance->imageOcrPhotoWordsWithLocation($image_file, $language, $preprocessing, $diagnostics);
    print_r($result);
} catch (Exception $e) {
...
# **imageOcrPost**
> \Swagger\Client\Model\ImageToTextResponse imageOcrPost($image_file, $language, $preprocessing)
